...
const navLinks = [
  ...
  const experiences = [
    ...
    },
    {
      ...
      points: [
        ...
        "Side project key features: Interactive UI/UX, Real-time data visualization, Shared data with secured login, etc. "],
      technologies: [
        "Node.js", "Express.js", "EJS", "JavaScript", "SQL", "LoadRunner", "Jenkins"
      ]
    },
  ];
  ...
  export { aboutDescription, navLinks, experiences, educations, certs };